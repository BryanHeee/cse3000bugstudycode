...
from app.utils import get_mysql_insert_query
...
results = repo.fetch(category=CATEGORIES[category],
                     from_date=datetime.datetime(
                         int(os.getenv("START_YEAR", "2017")),
                         int(os.getenv("START_MONTH", "1")),
                         int(os.getenv("START_DAY", "1")),
                         int(os.getenv("START_HOUR", "0")),
                         int(os.getenv("START_MINUTES", "0")),
                         tzinfo=tzutc()
                     ),
